...
* Автоматически перезаряжает ваше оружие когда осталось 0 патронов и продолжает стрелять дальше! (продолжение стрельбы может залагать иногда, это будет исправлено, когда [эта проблема](https://github.com/ValveSoftware/csgo-osx-linux/issues/3603) будет устранена)
...
### Функция автоматической паузы/возобновления spotify не работает
  
  Убедитесь, что окно spotify открыто, а не скрыто в трее
