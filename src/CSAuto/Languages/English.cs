...
namespace CSAuto.Languages
{
    class English
    {
        static Dictionary<string, string> translation = new Dictionary<string, string>()
        {
            ...
            ["msgbox_newerversion"] = "Found newer verison ({0}) would you like to download it?",
            ...
            ["server_computeronline"] = "Computer {0} ({1}) is online (CSAuto v{2})",
            ["server_loadedmap"] = "Loaded on map {0} in mode {1}",
            ...
            ["ckbox_oldscreencapture"] = "Use old screen capture technique",
        };
