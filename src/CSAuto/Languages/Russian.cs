...
namespace CSAuto.Languages
{
    class Russian
    {
        static Dictionary<string, string> translation = new Dictionary<string, string>()
        {
            ...
            ["msgbox_newerversion"] = "Найдена новая версия {0}, Хотите скачать её?",
            ...
            ["error_startup"] = "Случилась ошибка\n'{0}'\nПопытайтесь скачать последнюю версию с GitHub, если не помогло создайте отчет об ошибке с прикрепленным 'Error_Log.txt'.",
            ...
            ["server_computeronline"] = "Компьютер {0} ({1}) в сети (CSAuto v{2})",
            ["server_loadedmap"] = "Загрузился на карте {0} в режиме {1}",
            ["server_loadedlobby"] = "Загрузился в главном меню!",
            ["server_gamecrash"] = "Игра вылетела!",
            ["server_acceptmatch"] = "Принял матч!",
            ["menu_bombnotification"] = "Информация о бомбе",
            ...
            ["discord_ctscore"] = "{CTScore} - Счет спецназа",
            ...
            ["ckbox_oldscreencapture"] = "Использовать старую технику захвата экрана",
        };
